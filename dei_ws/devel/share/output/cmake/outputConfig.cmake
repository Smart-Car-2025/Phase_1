...
if("TRUE" STREQUAL "TRUE")
  set(output_SOURCE_PREFIX /home/smark/bfmc_2022/dei_ws/src/output)
  set(output_DEVEL_PREFIX /home/smark/bfmc_2022/dei_ws/devel)
  set(output_INSTALL_PREFIX "")
  set(output_PREFIX ${output_DEVEL_PREFIX})
else()
  set(output_SOURCE_PREFIX "")
  set(output_DEVEL_PREFIX "")
  set(output_INSTALL_PREFIX /home/smark/bfmc_2022/dei_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'output' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/smark/bfmc_2022/dei_ws/src/output/${idir}'.  ${_report}")
    endif()
