// Generated by gencpp from file utils/TopicInfo.msg
// DO NOT EDIT!


#ifndef UTILS_MESSAGE_TOPICINFO_H
#define UTILS_MESSAGE_TOPICINFO_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::utils::TopicInfo_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::utils::TopicInfo_<ContainerAllocator> const> ConstPtr;

}; // struct TopicInfo_

typedef ::utils::TopicInfo_<std::allocator<void> > TopicInfo;

typedef boost::shared_ptr< ::utils::TopicInfo > TopicInfoPtr;
typedef boost::shared_ptr< ::utils::TopicInfo const> TopicInfoConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::utils::TopicInfo_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::utils::TopicInfo_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::utils::TopicInfo_<ContainerAllocator1> & lhs, const ::utils::TopicInfo_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::utils::TopicInfo_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::utils::TopicInfo_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::utils::TopicInfo_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::utils::TopicInfo_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::utils::TopicInfo_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::utils::TopicInfo_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::utils::TopicInfo_<ContainerAllocator> >
{
  ...
  static const char* value(const ::utils::TopicInfo_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x0ad51f88fc44892fULL;
  static const uint64_t static_value2 = 0x8c10684077646005ULL;
};

template<class ContainerAllocator>
struct DataType< ::utils::TopicInfo_<ContainerAllocator> >
{
  static const char* value()
  {
    return "utils/TopicInfo";
  }
...
template<class ContainerAllocator>
struct Definition< ::utils::TopicInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::utils::TopicInfo_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::utils::TopicInfo_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::utils::TopicInfo_<ContainerAllocator>& v)
  {
    s << indent << "topic_id: ";
...
#endif // UTILS_MESSAGE_TOPICINFO_H
