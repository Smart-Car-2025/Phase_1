...
struct MD5Sum< ::utils::IMU_<ContainerAllocator> >
{
  ...
  {
    return "d3117643a08000ef6ca735b47f2c72d3";
  }

  static const char* value(const ::utils::IMU_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xd3117643a08000efULL;
  static const uint64_t static_value2 = 0x6ca735b47f2c72d3ULL;
};
