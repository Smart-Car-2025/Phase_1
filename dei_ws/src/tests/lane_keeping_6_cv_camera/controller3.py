...
POINT_AHEAD_CM = 28 #distance of the point ahead in cm
SEQ_POINTS_INTERVAL = 20 #interval between points in the sequence in cm 
NUM_POINTS = 5 #number of points in the sequence
L = 0.25  #length of the car, matched with lane_detection

class Controller():
    def __init__(self, k1=1.0,k2=1.0,k3=1.0, ff=1.0, cm_ahead=28, folder='training_imgs',
    ...
    def get_control(self, e2, e3, curv, desired_speed):
        ...
        #     curv = curv*30
        r = 1.0 / ( curv*6 ) #radius of curvature
