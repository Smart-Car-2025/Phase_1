...
echo_and_run cd "/home/smark/bfmc_2022/dei_ws/src/control"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/smark/bfmc_2022/dei_ws/src/control/setup.py" \
     \
    build --build-base "/home/smark/bfmc_2022/dei_ws/build/control" \
    install \
    --root="${DESTDIR-/}" \
