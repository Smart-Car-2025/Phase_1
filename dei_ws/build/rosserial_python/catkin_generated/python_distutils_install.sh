...
echo_and_run cd "/home/smark/bfmc_2022/dei_ws/src/rosserial_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/smark/bfmc_2022/dei_ws/src/rosserial_python/setup.py" \
     \
    build --build-base "/home/smark/bfmc_2022/dei_ws/build/rosserial_python" \
    install \
    --root="${DESTDIR-/}" \
