...
message(STATUS "utils: 6 messages, 2 services")

set(MSG_I_FLAGS "-Iutils:/home/smark/bfmc_2022/dei_ws/src/utils/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/smark/bfmc_2022/dei_ws/src/utils/msg/IMU.msg" NAME_WE)
add_custom_target(_utils_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "utils" "/home/smark/bfmc_2022/dei_ws/src/utils/msg/IMU.msg" ""
)

get_filename_component(_filename "/home/smark/bfmc_2022/dei_ws/src/utils/srv/subscribing.srv" NAME_WE)
add_custom_target(_utils_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "utils" "/home/smark/bfmc_2022/dei_ws/src/utils/srv/subscribing.srv" ""
)

get_filename_component(_filename "/home/smark/bfmc_2022/dei_ws/src/utils/msg/localisation.msg" NAME_WE)
add_custom_target(_utils_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "utils" "/home/smark/bfmc_2022/dei_ws/src/utils/msg/localisation.msg" ""
)

get_filename_component(_filename "/home/smark/bfmc_2022/dei_ws/src/utils/srv/RequestParam.srv" NAME_WE)
add_custom_target(_utils_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "utils" "/home/smark/bfmc_2022/dei_ws/src/utils/srv/RequestParam.srv" ""
)

get_filename_component(_filename "/home/smark/bfmc_2022/dei_ws/src/utils/msg/Log.msg" NAME_WE)
add_custom_target(_utils_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "utils" "/home/smark/bfmc_2022/dei_ws/src/utils/msg/Log.msg" ""
)

get_filename_component(_filename "/home/smark/bfmc_2022/dei_ws/src/utils/msg/environmental.msg" NAME_WE)
add_custom_target(_utils_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "utils" "/home/smark/bfmc_2022/dei_ws/src/utils/msg/environmental.msg" ""
)

get_filename_component(_filename "/home/smark/bfmc_2022/dei_ws/src/utils/msg/TopicInfo.msg" NAME_WE)
add_custom_target(_utils_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "utils" "/home/smark/bfmc_2022/dei_ws/src/utils/msg/TopicInfo.msg" ""
)

get_filename_component(_filename "/home/smark/bfmc_2022/dei_ws/src/utils/msg/vehicles.msg" NAME_WE)
add_custom_target(_utils_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "utils" "/home/smark/bfmc_2022/dei_ws/src/utils/msg/vehicles.msg" ""
)
...
_generate_msg_cpp(utils
  "/home/smark/bfmc_2022/dei_ws/src/utils/msg/IMU.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/utils
)
_generate_msg_cpp(utils
  "/home/smark/bfmc_2022/dei_ws/src/utils/msg/localisation.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/utils
)
_generate_msg_cpp(utils
  "/home/smark/bfmc_2022/dei_ws/src/utils/msg/Log.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/utils
)
_generate_msg_cpp(utils
  "/home/smark/bfmc_2022/dei_ws/src/utils/msg/environmental.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/utils
)
_generate_msg_cpp(utils
  "/home/smark/bfmc_2022/dei_ws/src/utils/msg/TopicInfo.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/utils
)
_generate_msg_cpp(utils
  "/home/smark/bfmc_2022/dei_ws/src/utils/msg/vehicles.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/utils
)
...
_generate_srv_cpp(utils
  "/home/smark/bfmc_2022/dei_ws/src/utils/srv/RequestParam.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/utils
)
_generate_srv_cpp(utils
  "/home/smark/bfmc_2022/dei_ws/src/utils/srv/subscribing.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/utils
)
